...
$req = $db->query('select * from membre where id=' . $_SESSION['id']);
if ($ligne = $req->fetch()) {
  $_POST['id'] = $ligne['id'];
  $_POST['nom'] = $ligne['nom'];
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                    <form id="formAccountSettings" method="POST" action="profil.php">
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Nom</label>
                          <input class="form-control" type="text" id="firstName" name="nom" autofocus value="<?php if (isset($_POST['nom'])) echo $_POST['nom']; ?>" />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="lastName" class="form-label">Prenom</label>
                          <input class="form-control" type="text" name="prenom" id="lastName" value="<?php if (isset($_POST['prenom'])) echo $_POST['prenom']; ?>" />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">Telephone</label>
                          <input class="form-control" type="text" id="email" name="telephone" placeholder="00 00 00 00" value="<?php if (isset($_POST['telephone'])) echo $_POST['telephone']; ?>" />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="organization" class="form-label">Login</label>
                          <input type="text" class="form-control" id="organization" name="login" value="<?php if (isset($_POST['login'])) echo $_POST['login']; ?>" />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label class="form-label" for="phoneNumber">Password</label>
                          <div class="input-group input-group-merge">
                            <input type="text" id="phoneNumber" name="password" class="form-control" placeholder="password" value="<?php if (isset($_POST['password'])) echo $_POST['password']; ?>" />
                          </div>
                        </div>
                      ...
                      <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-2" name="modifier">Save changes</button>
